    ...
    <>
          ...
          <nav className="navbar">
            <div>
              ...
              {openFeatures && <ul className="mt-2 ml-3 lg:ml-0 lg:p-3 lg:shadow">
                ...
                <li className="flex items-center justify-start text-sm mb-2"><img src={calender} alt="" className="mr-2" />Calender</li>
                <li className="flex items-center justify-start text-sm mb-2"><img src={reminders} alt="" className="mr-2" />Reminders</li>
      ...
      <section className="flex flex-col-reverse py-20 md:grid md:gap-10 md:grid-cols-2 md:place-items-center max-w-4xl lg:max-w-5xl md:mx-auto">
        <article className="text-center md:text-left px-5 xl:px-0 mt-10 md:mt-0 ">
          ...
          <button className="bg-black rounded-lg text-white font-blod hover:opacity-75 transition-all-duration-150 py-2 px-6 cursor-pointer">
            Learn more
          </button>
      ...
      <div className="attribution">
         ...
         Coded by <a href="#">Bamidele-Nelly Oluwatobiloba</a>.
      </div>
    </>
  )
}
